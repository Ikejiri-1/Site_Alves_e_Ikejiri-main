  ...
  return (
    <>
      <MainImage
        ...
        alt=""
        title="Contatos"
        description="Atendemos de forma totalmente online, para clientes em todo o Brasil. Para iniciar o atendimento, entre em contato pelo Whatsapp ou pelo e-mail."
        CTA={true}
      />
      <section>
